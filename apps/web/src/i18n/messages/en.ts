export default {
  app: {
    ...
    donate: {
      description:
        "This project doesn't have any sponsor, sugardaddy, sugarmommy, crypto-whale investor, bored millionaire, or mysterious trench-coat philanthropist. It runs purely on volunteer work, server bills, and a steady stream of kebab + coffee expenses — all of which only dig the financial hole deeper. Still, this app remains a love project.<br></br><br></br>If you want to support our cause and help make this website even worse, any amount is HIGHLY appreciated. If you don't have money to spare — honestly, who does in this economy? — you can still help by sharing this app and spreading the annoyance further.",
    ...
    wanPhone: {
      ...
      survey: {
        ...
        questionVariants: {
          ...
          variant_002: {
            text: 'What is the most common favorite color?',
            options: {
              option_001: 'Red',
              option_002: 'Green',
              option_003: 'Blue',
          ...
          variant_003: {
            text: "It has four legs, it's not a chair but a table",
            options: {
              option_001: 'Spider',
              option_002: 'Horse',
              option_003: 'Yes',
          ...
          variant_005: {
            ...
            options: {
              option_001: 'Yes',
              option_002: '700 pounds',
              option_003: '144',
              option_004: 'Inf',
              option_005: 'Rather not say',
            },
            solution: '700 pounds',
          },
          variant_006: {
            text: 'Finish the following: Well, well, well...',
            options: {
              option_001: 'How the turntables...',
              option_002: 'I did not hit her',
              option_003: "It's down there somewhere, let me take another look",
              option_004: "You can't park there",
            },
            solution: 'How the turntables...',
          },
          variant_007: {
            text: 'What is the following is not a phone brand',
            options: {
              option_001: 'Nokia',
              option_002: 'Samsung',
              option_003: 'Apple',
              option_004: 'Motorola',
              option_005: 'Blablabluba',
            },
            solution: 'Blablabluba',
          },
          variant_008: {
  ...
  cafeWall: {
    title: 'Cafe wall',
    description: 'You can generate a cafe wall illusion here. Give it a try!',
    tileColorA: 'Tile Color A',
    tileColorB: 'Tile Color B',
    tileSize: 'Tile Size',
    diamondColorA: 'Diamond Color A',
