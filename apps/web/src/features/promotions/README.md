...
```typescript
// Use DILF page
import { DilfPage } from '@/features/gift';
...
// Detect adblocker
import { useAdblockerDetector, AdblockerSuspectBar } from '@/features/gift';
...
// Use gift components
import { ContainerGiftFlaps, OneByOneGift } from '@/features/gift';
