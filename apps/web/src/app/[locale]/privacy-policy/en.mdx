...
The MAW is an open-source project that is publicly available through our <a href={config.githubUrl}>Git repository</a>. If you have any questions about this privacy policy, please contact us at <a href={`mailto:${config.contactEmail}`}>{config.contactEmail}</a>. We don't sell your personal data to anyone.
