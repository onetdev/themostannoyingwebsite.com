...
export function Screensaver() {
  ...
  const timeout = usePainPreferencesStore(
    (state) => state.screensaverTimeoutSeconds,
  );
      ...
      {isActive && isEnabled && (
        <motion.div
          ...
          <div className="absolute bottom-10 left-0 w-full text-center">
            <span className="pointer-events-none select-none text-xs tracking-widest text-white/50 uppercase">
              {isTouch
