...
type InInputGroupAddonProps = ComponentProps<'div'> &
...
export function InputGroupAddon({
  ...
  align = 'inline-start',
  ...props
}: InInputGroupAddonProps) {
  return (
    <>
      {/* biome-ignore lint/a11y/useSemanticElements: Radix relies on role=group */}
      {/* biome-ignore lint/a11y/useKeyWithClickEvents: Radix relies on onClick on static element` */}
      <div
        role="group"
