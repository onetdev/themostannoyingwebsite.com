...
4. **Agent Skill Support**:
   - Standardized via the `git-commit-conventional` skill to ensure AI agents consistently craft high-quality Conventional Commit messages matching the commitlint specification and commit locally without pushing.
